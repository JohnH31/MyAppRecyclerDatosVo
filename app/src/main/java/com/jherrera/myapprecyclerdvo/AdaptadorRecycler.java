...
public class AdaptadorRecycler extends RecyclerView.Adapter<AdaptadorRecycler.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AdaptadorRecycler.ViewHolder holder, int position) {
        holder.asignarDatos(listaDatos.get(position).getNombreR(),listaDatos.get(position).getTelefonoR(),listaDatos.get(position).getImagenR());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView textViewN, textViewT;
        ImageView imageView;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            textViewN = itemView.findViewById(R.id.txtNombreR);
            textViewT = itemView.findViewById(R.id.txtTelefonoR);
            imageView = itemView.findViewById(R.id.imgR);
        }
        public void asignarDatos(String nom, String tel, int img){
            textViewN.setText(nom);
            textViewT.setText(tel);
